...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Control" }, "s",
	        function ()
		    	awful.util.spawn("systemctl suspend -i")
	end),
...
--	end),
	...
	awful.key({ "Control" }, "XF86MonBrightnessUp",
			function ()
			    awful.util.spawn("sh /home/gnoale/.config/awesome/brightness.sh + eDP-1")
			end),
  ...
  awful.key({ modkey, "Control" }, "d",
			function ()
			    awful.util.spawn("autorandr desk")
			end),
	awful.key({ modkey, "Control", "Shift" }, "d",
			function ()
			    awful.util.spawn("autorandr lone")
			end)
...
awful.util.spawn("dropbox.py start")
